...
- Planned confirmation page: `https://voicetolegacy.org/thank-you/`
...
- Real browser submission: PENDING
- Invalid-data test: PENDING
- Duplicate test: PENDING
- Mobile test: PENDING
- Public `/start/` rebuild: LOCKED UNTIL BACKEND TESTS PASS
- Production merge: LOCKED
- Google Ads funding: LOCKED
